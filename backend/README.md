...
## Project Structure
    ...
    ├── melv_rapidproto_ale_36012  # Django project configurations
...
1. Clone this repo and `cd melv_rapidproto_ale_36012`
...
2. Clone this repo and `cd melv_rapidproto_ale_36012`
